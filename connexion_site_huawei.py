...
reference = pyautogui.locateOnScreen("Home_Page_huawei.png",region=(0,0,pyautogui.size().width,pyautogui.size().height),confidence=0.8)
...
reference = pyautogui.locateOnScreen("depenses_huawei.png",region=(0,0,pyautogui.size().width,pyautogui.size().height),confidence=0.8)
while reference == None:
    time.sleep(1)
    reference = pyautogui.locateOnScreen("depenses_huawei.png",region=(0,0,pyautogui.size().width,pyautogui.size().height),confidence=0.8)
